...
const Filters = () => {
    ...
    return (
        ...
        <select className={s.select} name="alphabetical" onChange={handleAlphabeticalSort}>
            <option disabled selected>Alphabetical</option>
            <option value="atoz">A to Z</option>
            <option value="ztoa">Z to A</option>
        </select>

        <select className={s.select} name="numerical" onChange={handleScoreSort}>
            <option disabled selected>Score</option>
            <option value="asc">From Min to Max</option>
            <option value="desc">From Max to Min</option>
        </select>

         <select className={s.select} name="diets" id="diets" onChange={handleFilterBy}>
            <option>Type of Diet</option>
            {
